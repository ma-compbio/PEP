...
The motif frequency feature data we prepared and used for PEP-Motif are available at http://genome.compbio.cs.cmu.edu/~yy3/PEP/motif_feature/. There is a file folder for each studied cell line. There are three files in each file folder of a cell line:
